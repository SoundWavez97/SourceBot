...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (Member.id === message.author.id)
      return message.channel.send(`<a:wrong:752200833348665354>You Can't Kick Your Self!`);

    if (Member.id === client.user.id)
      return message.channel.send(`<a:wrong:752200833348665354>Please Don't Kick Me ;-;`);

    if (Member.id === message.guild.owner.user.id)
      return message.channel.send(`<a:wrong:752200833348665354>You Can't Kick Owner Of Server!`);
    ...
    if (UserRole <= Role) return message.channel.send(`<a:wrong:752200833348665354>I Can't Kick That Member Because That Member Has Role Position Is Higher Than My Role Or Same Role As You!`);
    
    if (BotRole <= Role) return message.channel.send(`<a:wrong:752200833348665354>I Can't Kick That Member Because That Member Has Role Position Is Higher Than My Role Or Same Role As Me!`);
    
    if (!User.kickable) return message.channel.send(`<a:wrong:752200833348665354>I Can't Kick That Member!`)
